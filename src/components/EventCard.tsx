                            ...
                            <p className="text-sm text-gray-700 mt-1">
                                {gridRows_e[index].role} @ {gridRows_e[index].company}
                                {
                                    (gridRows_e[index].linkedinUrl != "") ?
                                        <>
                                        <a  href={gridRows_e[index].linkedinUrl}
                                    ...
                                    <p className="text-sm text-gray-700 mt-1">
                                        {gridRows_o[index].role} @ {gridRows_o[index].company}
                                        {
                                            (gridRows_o[index].linkedinUrl != "") ?
                                                <>
                                                <a  href={gridRows_o[index].linkedinUrl}
                                                    className='text-slate-800 hover:text-slate-600 dark:text-slate-100 dark:hover:text-white'
                                                    target='_blank'
                                                    rel='noreferrer'>
                                                    <span className='sr-only'>LinkedIn</span>
                        ...
                        <div className="flex justify-between items-center px-6 py-4">
                            {
                                (event.youtubeUrl) ?
                                    ...
                                    :
                                    (<>
                                        <div className="bg-orange-600 text-xs uppercase px-2 py-1 rounded-full border border-gray-200 text-gray-500 font-bold">Youtube video ancora non disponibile</div>
                                    </>)
                            }
