...
export default function LocaleSwitcher(props: {
    ...
    return (
        <div className="flex flex-row p-4 gap-x-1 items-center">
            ...
            <div className="cursor-pointer w-8 h-4 rounded" style={{ backgroundColor: "rgb(71 85 105 / 1)" }} onClick={(e) => toggle(e)}>
                <div className={`bg-white w-1/2 h-full rounded-full ${locale} ${animation}`} />
            </div>
